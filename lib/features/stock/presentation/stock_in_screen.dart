...
class _StockInScreenState extends State<StockInScreen> {
  ...
  void _showConfirmationDialog(int quantity, int currentStock, int newStock) {
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  _buildDialogRow('Current Stock', '$currentStock units'),
                  const SizedBox(height: 8),
                  _buildDialogRow(
                    'Quantity Received',
                    '+$quantity units',
                    valueColor: AppColors.statusApprovedText,
                  ),
                  const SizedBox(height: 8),
                  const Divider(color: AppColors.border),
                  const SizedBox(height: 8),
                  _buildDialogRow('New Stock', '$newStock units', isBold: true),
