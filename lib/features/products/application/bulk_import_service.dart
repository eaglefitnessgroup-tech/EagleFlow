...
class BulkImportService {
  ...
  List<int> generateSampleZip() {
    ...
    // Generate sample images with distinct colors
    Uint8List generateImageBytes(String code, img.Color color) {
      final image = img.Image(width: 300, height: 300);
      img.fill(image, color: color);

      final x = (300 - (code.length * 28)) ~/ 2;
      img.drawString(
        image,
        code,
        font: img.arial48,
    ...
    final img1 = generateImageBytes(
      'EXAMPLE-001',
      img.ColorRgb8(74, 144, 226),
    ); // Blue
    final img2 = generateImageBytes(
      'EXAMPLE-002',
      img.ColorRgb8(80, 227, 194),
    ); // Teal
    final img3 = generateImageBytes(
      'EXAMPLE-003',
      img.ColorRgb8(245, 166, 35),
    ); // Orange

    archive.addFile(ArchiveFile('images/EXAMPLE-001.jpg', img1.length, img1));
    archive.addFile(ArchiveFile('images/EXAMPLE-002.jpg', img2.length, img2));
